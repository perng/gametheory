...
function record(inputBuffer){
  ...
  // could add code here, when recLength > threshold, exportWAV and clear.
  // but it's hard to access exportWAV here, so do it in recordmp3.js.
  //console.log('recLen = ' + recLength); // increment by buffer size.
}
